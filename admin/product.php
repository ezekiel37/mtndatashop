            ...
            <div class="modal-body">
              ...
              <form id="addplanform">
                <div class="mb-2">
                  ...
                  <input name="proname" type="text" class="form-control" id="proname" aria-describedby="emailHelp">

                </div>
                <div class="mb-2">
                  <label for="exampleInputEmail1" class="form-label">Api id</label>
                  <input name="proapi" type="text" class="form-control" id="proapi" aria-describedby="emailHelp">

                </div>
                <div class="mb-2">
                  <label for="exampleInputEmail1" class="form-label">Offline sale</label>
                  <input name="prooffline" type="text" class="form-control" id="prooffline" aria-describedby="emailHelp">

                </div>
                <div class="mb-2">
                  <label for="exampleInputPassword1" class="form-label">Category</label>
                  <input name="procat" type="text" class="form-control" id="procat">
                </div>
                <div class="mb-2">
                  <label for="exampleInputPassword1" class="form-label">Referral Commission</label>
                  <input name="proref" type="text" class="form-control" id="proref">
                </div>
                <div class="mb-2">
                  <label for="exampleInputPassword1" class="form-label">Cost price</label>
                  <input name="procost" type="text" class="form-control" id="procost">
                </div>
