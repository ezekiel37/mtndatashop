...
<?php
          require("./connect.php");
          $myaccount = "select * from gbengaccount";
...
<!--form start -->
  ...
  <div class="mb-3">
    <label for="walletamount" class="form-label">Remaining Balance</label>
    <input type="text" readonly="readonly"  value="<?php echo ($rows['remaining']);?>" 
    class="form-control" name="suballet" id="suballet" aria-describedby="emailHelp">
   </div>
   <div class="mb-3">
    <label for="usernumber" class="form-label">User Number or Name</label>
    <input type="text" class="form-control" name="id" placeholder="User Number" id="search">
  </div>
  <div id="display"></div>
  <div class="mb-3">
